    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            for (var i = 0; i < citations.length; i++) {
                result[i] = citations.slice(0, i + 1).reduce(function (p, i) {
                    return p + i;
                });
            }
...
function showMarkers(affiliations) {
    ...
    for (var i = 0; i < affiliations.length; i++) {
        ...
        var image = "http://83.212.97.66/static/img/marker_2.png";
                ...
                for (key in coll_authors) {
                    ...
                    links = links + "<div class='dep_author'> \
                                            <div class='marker_author_image'>  \
                                                <img src='http://83.212.97.66/static/img/photo_profile/" + logo + ".jpg' height='25' width='25'> \
                                            </div> \
